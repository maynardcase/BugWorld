...
public class Bug {
    ...
    private String name;
    final Logger logger = LoggerFactory.getLogger(Bug.class);
    ...
    public Bug(int energy, GridLocation loc, Direction direction, Breed breed) {
        this.energy = energy;
        this.loc = loc;
    ...
    public void breedWhenReady(String variable, Integer testValue) {
        ...
        if (variableValue.compareTo(testValue) > 0) {
            ...
            Bug childBug = new Bug(newEnergy, childBugLoc, childBugDirection, breed);
